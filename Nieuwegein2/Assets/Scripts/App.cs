...
public class App : MonoBehaviour
{
    ...
    site3UI, site4, site4UI, site5, site5UI, map, player, mainPanel, statusPanel, sitePathSpawner, PanelLayoutHandler, miniMapPanel, wrongSitePanel, gameController;
    public Camera arCamera, mapCamera;
    public GameObject[] taskPanels;
    public Button back_button, showMap_button, forwardButton;
    ...
    public void status_bttn(){
        ...
        for (int i = 1; i < PanelLayoutHandler.GetComponent<PanelLayoutHandler>().panels.Length; i++){
            // i=8 is the distance warning panel at site 2
            // i=19 is the minimap panel at site 3
            if(i != 8 && i != 19 && PanelLayoutHandler.GetComponent<PanelLayoutHandler>().panels[i].activeSelf){
