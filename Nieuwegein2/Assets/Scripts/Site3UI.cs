...
public class Site3UI : MonoBehaviour
{
    ...
    bool animate;
    public GameObject tank_L, tank_P, droplet_L, droplet_P, gameController, incorrectOrderPanel;
    ...
    public void ok_taskPanel_bttn(){
        if(order[0] == correct_order[0] && order[1] == correct_order[1] && order[2] == correct_order[2]){
            ...
            // }else{
            //     scoreText_taskCompletedPanel_L.text = "The order was pipe, tap. You had "+ attempts.ToString() + " attempts, so you lost " + attempts.ToString() + 
            //     "x10=" +  (attempts*10).ToString() + " liters of water.\n\n" + "Your new score: " + gameController.GetComponent<gameController>().score.ToString() + 
            //     " liters";
            //     scoreText_taskCompletedPanel_P.text = "The order was pipe, tap. You had "+ attempts.ToString() + " attempts, so you lost " + attempts.ToString() + 
            //     "x10=" +  (attempts*10).ToString() + " liters of water.\n\n\n" + "Your new score: " + gameController.GetComponent<gameController>().score.ToString() + 
            //     " liters";
            // }
